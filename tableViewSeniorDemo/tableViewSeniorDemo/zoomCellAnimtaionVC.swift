...
class zoomCellAnimtaionVC: UIViewController {
...
extension zoomCellAnimtaionVC: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, willDisplay cell: UITableViewCell, forRowAt indexPath: IndexPath) {
        ...
        let transform = CGAffineTransform.init(scaleX: 3, y: 2)
